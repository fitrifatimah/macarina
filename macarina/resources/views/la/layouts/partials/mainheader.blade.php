...
<header class="main-header" >
	...
	<!-- Logo -->
	<a href="{{ url(config('laraadmin.adminRoute')) }}" class="logo" style="background-color: #D48012">
		<!-- #3A3431 -->
	...
	<!-- Header Navbar -->
	<nav class="navbar navbar-static-top" role="navigation" style="background-color: #D48012">
	@if(LAConfigs::getByKey('layout') == 'layout-top-nav')
		<div class="container">
