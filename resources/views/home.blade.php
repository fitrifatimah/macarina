...
<div id="navigation" class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><b>MaFranchise</b></a>
        </div>
...
<div id="headerwrap" style="background-color: #DC143C" >
    <div class="container" style="background: url(la-assets/img/m1.jpg); ">
        <div class="row centered">
            <div class="col-lg-12">
                <h1>MaFranchise</a></b></h1>
                <!-- <h3>{{ LAConfigs::getByKey('site_description') }}</h3> -->
                @if (Auth::guest())
                   <h3><a href="{{ url('/login') }}" class="btn btn-lg btn-success">Login</a></h3><br>
                @else
                    <h3><a href="{{ url(config('laraadmin.adminRoute')) }}" class="btn btn-lg btn-success">{{ Auth::user()->name }}</a></h3><br>
                @endif
